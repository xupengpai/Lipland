            ...
            if (tag0 == startTag) { // XML START TAG
                ...
                for (int ii = 0; ii < numbAttrs; ii++) {
                    ...
                    String attrValue = attrValueSi != -1 ? compXmlString(xml, sitOff, stOff,
                            attrValueSi) : "" + Integer.toString(attrResId);
...
//                prtIndent(indent, "</" + name + ">  (line " + startTagLineNo + "-" + lineNo + ")");
                ...
                // System.err.println("  Unrecognized tag code '" +
                // Integer.toHexString(tag0)
                // + "' at offset " + off);
                break;
            }
        } // end of while loop scanning tags and attributes of XML tree
        // System.err.println("    end at offset " + off);
    ...
    public void prtIndent(int indent, String str) {
        String msg = spaces.substring(0, Math.min(indent * 2, spaces.length())) + str;
//        System.err.println(msg);
        stringBuffer.append(msg);
//        try {
//            if (fileWriter == null){
//                fileWriter = new FileWriter(new File("/sdcard/test.xml"));
//            }
